...
export const metadata: Metadata = {
  title: "Gifts Under ₹999 — Personalized Gifts India | Gifteeng",
  description:
    "Shop personalized gifts under ₹999 — premium photo products, custom hampers, engraved items, and more. Perfect for every occasion. Pan-India delivery.",
  alternates: { canonical: `${SITE}/gifts-under-999` },
  openGraph: {
    title: "Gifts Under ₹999 — Personalized Gifts India | Gifteeng",
    description: "Premium personalized gifts under ₹999 with pan-India delivery.",
    url: `${SITE}/gifts-under-999`,
    type: "website",
  },
};
...
async function getProducts(): Promise<Product[]> {
  ...
  const data = await fetch(
    `${api}/api/products?maxPrice=999&pageSize=12&sort=popular`,
    { next: { revalidate: 300 } }
  )
      ...
      <section className="bg-gradient-to-br from-[#EF3752]/10 via-background to-background py-14 text-center">
        <div className="mx-auto max-w-2xl px-4">
          ...
          <p className="text-muted-foreground">
            High-quality personalized gifts under ₹999, from premium photo
            products to custom hampers. Make every occasion memorable without
            overspending.
          </p>
        </div>
      </section>
