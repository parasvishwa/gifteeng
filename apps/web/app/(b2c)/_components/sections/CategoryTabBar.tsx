...
export default function CategoryTabBar() {
  ...
  return (
    <div className="mb-3 -mx-4">
      ...
      {/* Swipe hint — mobile only, hidden once user has scrolled (CSS only) */}
      <p className="md:hidden text-center text-[10px] text-muted-foreground/45 font-medium tracking-wide mt-0.5 pb-0.5 select-none pointer-events-none" aria-hidden>
        swipe →
      </p>
    </div>
  );
