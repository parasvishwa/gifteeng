...
export const metadata: Metadata = {
  ...
  openGraph: {
    title:       "Privacy Policy – Gifteeng",
    description: "How Gifteeng collects, uses, and protects your personal information.",
    url:         `${SITE}/privacy`,
    type:        "website",
  },
  twitter: {
...
const SECTIONS: Section[] = [
  {
    ...
    title: "1. Overview",
    content: [
      "Imazyn Ecommerce Pvt Ltd (\"Gifteeng\", \"we\", \"our\") operates www.gifteeng.com and the Gifteeng mobile applications for Android and iOS. This Privacy Policy explains what data we collect, why we collect it, and how we use and protect it across both web and mobile platforms.",
      ...
      "This policy was last updated in May 2026. We may update it periodically; continued use after an update constitutes acceptance.",
    ],
  },
  {
  ...
  },
  {
    id: "mobile-apps",
    icon: Smartphone,
    title: "10. Mobile Applications",
    content: [
      "Our Android and iOS apps share the same backend, account, and policies as our website. The app may request the following device permissions; you can grant or revoke each one in your phone settings at any time.",
    ],
    list: [
      {
        bold: "Camera & Photo Library:",
        text: "Used only when you choose to upload a photo for product customisation (e.g. a personalised mug or frame). We do not access your camera or photo library otherwise. The photos you upload are stored securely and used solely to fulfil your order.",
      },
      {
        bold: "Push Notifications:",
        text: "If you allow notifications, we send order updates, dispatch alerts, delivery confirmations, and (with your separate consent) promotional offers. Push tokens are stored against your account and dropped immediately if you revoke notification permission, log out, or delete your account.",
      },
      {
        bold: "Network State:",
        text: "Read by the app to show offline messaging when you have no connection. We do not log network details.",
      },
      {
        bold: "Crash & Performance Data:",
        text: "If enabled, the app sends anonymised crash reports and performance metrics so we can fix bugs. Toggle this off in Privacy & Data Controls under your account.",
      },
      {
        bold: "App Tracking Transparency (iOS):",
        text: "On first launch, iOS will ask whether you allow Gifteeng to track activity across other apps and websites. Choosing \"Ask App Not to Track\" disables Meta Pixel and similar SDKs in the app — the app and your account work normally either way.",
      },
      {
        bold: "Advertising ID:",
        text: "We do not use the Android Advertising ID or iOS IDFA for ad personalisation. We may include it in anonymised crash reports if you have enabled crash reporting.",
      },
      {
        bold: "In-App Purchases:",
        text: "Physical-product orders placed through the app are processed by Razorpay, the same as on the website. Apple's In-App Purchase and Google Play Billing systems are not used because no digital goods or subscriptions are sold through the app.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    list: [
      ...
      { bold: "Deletion:", text: "Request deletion of your account and associated personal data (subject to legal retention requirements). Visit gifteeng.com/account-deletion or your account's Privacy & Data Controls to request immediately." },
      { bold: "Data Export:", text: "Download a JSON file of everything we hold about you, on demand." },
      ...
      <section className="bg-muted/40 py-16 md:py-24">
        <div className="mx-auto max-w-4xl px-4 text-center">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto text-base md:text-lg">
            ...
            across both our website and mobile apps.
            Last updated: <span className="font-semibold text-foreground">May 2026</span>.
          </p>
        </div>
      </section>
          ...
          <aside className="hidden lg:block">
            <div className="sticky top-24 space-y-1">
              ...
              <div className="pt-4 border-t border-border mt-4">
                <Link href="/terms" className="text-[12px] text-primary hover:underline block">Terms & Conditions →</Link>
                <Link href="/shipping" className="text-[12px] text-primary hover:underline block mt-1">Shipping Policy →</Link>
                <Link href="/returns" className="text-[12px] text-primary hover:underline block mt-1">Return Policy →</Link>
              </div>
            </div>
          </aside>
