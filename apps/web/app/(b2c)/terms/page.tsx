...
export const metadata: Metadata = {
  ...
  openGraph: {
    title:       "Terms & Conditions – Gifteeng",
    description: "Terms governing your use of Gifteeng products and services.",
    url:         `${SITE}/terms`,
    type:        "website",
  },
  twitter: {
  ...
  },
  {
    ...
    subsections: [
      ...
      },
      {
        ...
        content: ["100 Goins = ₹1 discount at checkout. Redemption is subject to:"],
        list: [
      ...
      },
      {
        ...
        list: [
          { text: "Change the earning rate, redemption value (currently 100G = ₹1), or any terms of the Goins programme" },
          ...
          <aside className="hidden lg:block">
            <div className="sticky top-24 space-y-1">
              ...
              <div className="pt-4 border-t border-border mt-4">
                <Link href="/privacy" className="text-[12px] text-primary hover:underline block">Privacy Policy →</Link>
