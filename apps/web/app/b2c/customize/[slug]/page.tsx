...
import { ArrowLeft, Copy, Loader2, Check, ShoppingCart, Sparkles, Plus } from "lucide-react";
  ...
  const onSave = useCallback(async () => {
    ...
    try {
      ...
      if (editOrderId && editItemId) {
        ...
        setAddOK(true);
        setTimeout(() => router.push(`/b2c/orders/${editOrderId}`), 800);
        return;
      }
      ...
      setAddOK(true);
      setTimeout(() => router.push("/b2c/cart"), 800);
    } catch (e: any) {
      ...
      <div className="sticky top-[94px] md:top-[96px] z-20 backdrop-blur border-b shadow-sm"
        ...
        <div className="max-w-2xl mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-gray-400">Personalise your product</p>
          </div>
