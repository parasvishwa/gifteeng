...
export default function PrivacyPage() {
  ...
  if (authed === false) {
    return (
      <div className="mx-auto max-w-md p-8 text-center">
        ...
        <Link href="/b2c/account" className="text-primary underline text-sm">Go to account</Link>
      </div>
    );
  }
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 pt-16 md:pt-20 pb-24">
      <Link href="/b2c/account" className="inline-flex items-center gap-1 text-xs text-muted-foreground hover:underline mb-3">
      ...
      <p className="text-[11px] text-muted-foreground text-center">
        Read our full <Link href="/b2c/privacy" className="underline">privacy policy</Link>.
