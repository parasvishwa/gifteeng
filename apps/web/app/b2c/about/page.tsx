...
const values = [
  ...
  { icon: Users, title: "1Cr+ Happy Customers", desc: "Trusted by millions for their special moments." },
];
        ...
        <div className="mx-auto max-w-4xl px-4">
          <div className="bg-[#12131A] py-14 md:py-20 rounded-2xl">
            <div className="mx-auto max-w-3xl px-4 grid grid-cols-3 gap-6 text-center">
              {[
                { value: "1L+", label: "Products Delivered" },
                { value: "95K+", label: "Happy Customers" },
