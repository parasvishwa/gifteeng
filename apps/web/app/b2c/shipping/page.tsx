      ...
      <section className="py-12 md:py-16">
        <div className="mx-auto max-w-4xl px-4 space-y-14">
          ...
          <div className="border-t border-border pt-8 flex flex-wrap gap-4 text-sm">
            <Link href="/b2c/returns" className="text-primary hover:underline">Return & Refund Policy →</Link>
            <Link href="/b2c/terms" className="text-primary hover:underline">Terms & Conditions →</Link>
            <Link href="/b2c/contact" className="text-primary hover:underline">Contact Support →</Link>
            <Link href="/b2c/track" className="text-primary hover:underline">Track Your Order →</Link>
          </div>
        </div>
      </section>
    </>
